...
obj=import_dx_resource(source,create_collection("R4G Bounds"),load_textures=False,show_collision=False).object
...
assert rebuilt.output_model.collision.spatial_bounds_1339.maximum[1]>1.440315842628479
assert rebuilt.output_sha256=="7de8988d598de649d993ae132e80353da60b8393a154da73b5fb4b7e08db56ce"
exported,report=export_topology(obj,output)
assert exported.data==rebuilt.data
print("R4G_BLENDER_BOUNDS_PASS",json.dumps({"candidate_sha256":rebuilt.output_sha256,"compilation":compiled.to_dict()}))
