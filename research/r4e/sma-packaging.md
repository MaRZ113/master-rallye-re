...
The E5 archive was packed from the full unpacked original tree with only Astero/car.dx replaced by E1. It has 7,595 file members; the original ZIP also includes directory entries. E5 is `STRUCTURALLY_VALID`. Human E5 testing confirms the original game accepted this full-tree Python archive, loaded Astero, and displayed E1. Sparse or malformed archives remain unproved.
